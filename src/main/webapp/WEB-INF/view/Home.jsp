...
<body>
	...
	<div class="container">
			...
			<div class="row" style="margin-top: 10px">
				...
				<p class="col-md-2">Tên : 
				<input name="hoten"  class="form-control"> </p>
				
				<p class="col-md-2">Cân nặng : 
				<input name="cannang" type="number" class="form-control"> </p>
				<p class="col-md-2 ">
			...
			<g:if test="${sessionScope.name !=null}">
				...
				<button style="float: right; margin-bottom: 20px"
					...
					<a href="/Datph14486_AssJava4/index" style="color: black">Tạo
						Giáo Viên Mới</a>
				</button>
			</g:if>
					...
					<tr>
						...
						<g:if test="${sessionScope.role !=null}">
							<td style="padding-right: 60px; display: flex; col: auto"><a
								style="pading-right: 30px" href="/Datph14486_AssJava4/update?id=${gv.id}"
								class="btn btn-warning col-auto">UPDATE</a> <g:if
									test="${sessionScope.role== sessionScope.admin}">
									<a style="margin-left: 5px" href="/Datph14486_AssJava4/delete?id=${gv.id}"
